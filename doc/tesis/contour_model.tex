...
\begin{imagen}
    \position{htb!}
    \file{images/narmour_all.png}
    \labelname{fig:narmour_all}
    \desc{Distribuci'on inferida a partir de la ecuaci'on \ref{eq:naive_bayes_narmour_model}}
    \width{10cm}
\end{imagen}

\begin{imagen}
    \position{htb!}
    \file{images/narmour_pitch_profile.png}
    \labelname{fig:narmour_w_pitch_profile}
    \desc{Pitch profile de  Beethoven, Sonata Op. 10 No. 1, II}
    \width{10cm}
\end{imagen}

\begin{imagen}
    \file{images/narmour_ref_note_tonic_all.png}
    \labelname{fig:narmour_reference_note1}
    \desc{Distribuci'on inferida a partir de la ecuaci'on \ref{eq:narmour_w_pitch_profile} asumiendo que $n_1=D\sharp$}
    \width{10cm}
\end{imagen}

\begin{imagen}
    \file{images/narmour_ref_note_seventh_all.png}
    \labelname{fig:narmour_reference_note2}
    \desc{Distribuci'on inferida a partir de la ecuaci'on \ref{eq:narmour_w_pitch_profile} asumiendo que $n_1=D\sharp$}
    \width{10cm}
\end{imagen}
\clearpage
...
En \cite{Schellenberg96}, el autor not'o que existe redundancia en los principios propuestos por \cite{Narmour90}, y con el objeto de explicar los datos
