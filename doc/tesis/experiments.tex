...
%En el presente trabajo se plantea como hip'otesis que el an'alisis de melod'ias generadas autom'aticamente por algoritmos con sustento cognitivo 
%podr'ia ayudar a validar o aportar nuevo conocimiento a las teor'ias cognitivas en las que estos se basan. Con este objetivo, mediante 
%t'ecnicas de aprendizaje autom'atico, se construyeron modelos generativos generar melod'ias en base a la jerarqu'ia m'etrica, la jerarqu'ia tonal, contornos mel'odicos, 
%organizaci'on discursiva y elaboraci'on mot'ivica.
%
%Los experimentos conducidos en este trabajo, muestran evidencia de que esta hip'o
%
%
%
%
...
%
%
%En el presente trabajo se propone y se pone a prueba una metodolog'ia novedosa que tiene como objetivo ayudar a validar y aportar 
%conocimiento al area de psicolog'ia de la m'usica. Esta metodolog'ia toma como hip'otesis que el an'alisis de melod'ias construidas
%por algoritmos generativos con sustento cognitivo permitir'ian aportar informaci'on 'util a la psicolog'ia cognitiva de la m'usica.
%
%
%consiste en construir modelos generativos para atributos musicales
%basados en teor'ias psicol'ogicas que prediquen s
%
%Para alcanzar ese objetivo, se implementaron algoritmos no supervisados, 
%que mediante t'ecnicas de aprendizaje autom'atico construyan modelos con un buen fundamento cognitivo para acento m'etrico, 
%inferencia de la tonalidad, contornos mel'odicos, fraseo y elaboraci'on mot'ivica. 
%
%Los resultados de los experimentos conducidos en este trabajo aportan evidencia significativa para creer que la 
%metodolog'ia propuesta permitir'ia no s'olo ayudar a validar ciertos postulados de teor'ias cognitivas musicales, sino tambi'en 
%aportar nuevos resultados.
%
%De esta forma, se considera a futuro elaborar los modelos para eliminar ciertas simplificaci'ones introducidas, como tambi'en 
%analizar que tipo conclusiones podr'ian sacarse a partir de su utilizaci'on.
%
%
%
%
%\begin{itemize}
% \item Hip'otesis del trabajo
...
% \item Conclusi'on propiamente dicha
