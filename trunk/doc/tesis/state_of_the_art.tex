...
``Contando con modelos generativos aislados para distintos atributos musicales, es posible analizar el impacto que tiene un cierto atributo en la cognici\'on musical
